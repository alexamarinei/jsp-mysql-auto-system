	...
	<nav class="navbar navbar-expand-lg nav-back fixed-top" id="mainNav">
	 ...
	 <div id="container">
         <header>Client</header>
          <br/><br/><br/><br/>
         <form  action="editeazaClient.jsp" method="post">
            <fieldset>
               <br/>
               <input type="text" name="id_client" id="id_client" placeholder="id_client" required autofocus>
               <br/><br/>
               <input type="text" name="Nume" id="Nume" placeholder="Nume" required>
               <br/><br/>
                <input type="text" name="Prenume" id="Prenume" placeholder="Prenume" required>
               <br/><br/>
               <input type="text" name="Adresa" id="Adresa" placeholder="Adresa" required>
               <br/><br/>
                <input type="text" name="CNP" id="CNP" placeholder="CNP" required>
               <br/><br/>
               <input type="text" name="Nr_Tel" id="Nr_Tel" placeholder="Nr_Tel" required>
               <br/> <br/> <br/>
               <label for="submit"></label>
               <input type="submit" name="submit" id="submit" value="Editeaza Mecanic">
            </fieldset>
         </form>
      </div>
</body>