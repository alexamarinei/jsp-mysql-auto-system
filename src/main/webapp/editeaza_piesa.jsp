...
<body>
	<nav class="navbar navbar-expand-lg nav-back fixed-top" id="mainNav">
	 ...
	 <div id="container">
         <header>Piesa</header>
          <br/><br/><br/><br/>
         <form  action="editeazaPiesa.jsp" method="post">
            <fieldset>
               <br/>
               <input type="text" name="id_piesa" id="ID" placeholder="ID" required autofocus>
               <br/><br/>
               <input type="text" name="Cantitate" id="Cantitate" placeholder="Cantitate" required>
               <br/><br/>
                <input type="text" name="Denumire" id="Denumire" placeholder="Denumire" required>
               <br/><br/>
                <input type="text" name="Pret" id="Pret" placeholder="Pret" required>
               <br/><br/>
               <input type="text" name="Gramaj" id="Gramaj" placeholder="Gramaj" required>
               <br/><br/>
                <label for="submit"></label>
               <input type="submit" name="submit" id="submit" value="Editeaza Piesa">
            </fieldset>
         </form>
      </div>
</body>